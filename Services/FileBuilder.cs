...
public class FileBuilder : IFileBuilder
{
    ...
    private string? ResolveValue(ColumnSource source, ColumnProfile col, UploadRecord record, CustomerProfile profile)
    {
        ...
        return source switch
        {
            ...
            ColumnSource.BoxVolume        => record.BoxVolume.HasValue    ? FormatDecimal(record.BoxVolume.Value, csv)    : null,
            ColumnSource.LiquidVolume     => record.LiquidVolume.HasValue ? FormatDecimal(record.LiquidVolume.Value, csv) : null,
